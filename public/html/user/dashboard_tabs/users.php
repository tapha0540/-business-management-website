        ...
        <div class="table-actions">
            ...
            <button class="btn btn-primary btn-sm" type="button" data-bs-toggle="modal"
                ...
                <span class="app-icon" aria-hidden="true"><svg viewBox="0 0 24 24">
                    ...
                    </svg></span> Ajouter un utilisateur
            </button>
        </div>
    </div>
                    ...
                    <tr id="utilisateurs-row-template" class="d-none">
                        ...
                        <td class="text-end table-actions-cell">
                            <button class="btn btn-sm btn-outline-info btn-action btn-edit icon-btn"
                                title="Éditer cet utilisateur" aria-label="Éditer cet utilisateur" type="button"
                                data-bs-toggle="modal" data-bs-target="#modifier-utilisateur"><span class="app-icon"
                                    aria-hidden="true"><svg viewBox="0 0 24 24">
                                        <path d="M12 20h9"></path>
                                        <path d="M16.5 3.5a2.1 2.1 0 0 1 3 3L7 19l-4 1 1-4 12.5-12.5z"></path>
                                    </svg></span></button>
                            <button class="btn btn-sm btn-outline-danger btn-action btn-delete icon-btn"
                                title="Supprimer cet utilisateur" aria-label="Supprimer cet utilisateur"><span
                                    class="app-icon" aria-hidden="true"><svg viewBox="0 0 24 24">
                                        <path d="M3 6h18"></path>
                                        <path d="M8 6V4h8v2"></path>
                                        <path d="M19 6l-1 14H6L5 6"></path>
                                        <path d="M10 11v6"></path>
